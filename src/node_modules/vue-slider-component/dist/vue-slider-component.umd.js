...
// module
exports.push([module.i, ".vue-slider{position:relative;-webkit-box-sizing:content-box;box-sizing:content-box;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;display:block;-ms-touch-action:none;-webkit-tap-highlight-color:rgba(0,0,0,0)}.vue-slider-disabled{pointer-events:none}.vue-slider-rail{position:relative;width:100%;height:100%;-webkit-transition-property:width,height,left,right,top,bottom;transition-property:width,height,left,right,top,bottom}.vue-slider-process{position:absolute;z-index:1}.vue-slider-sr-only{clip:rect(1px,1px,1px,1px);height:1px;width:1px;overflow:hidden;position:absolute!important}", ""]);
...
function (_Vue) {
  ...
  function VueSliderDot() {
    ...
    return _possibleConstructorReturn(this, getPrototypeOf_getPrototypeOf(VueSliderDot).apply(this, arguments));
  }
...
vue_slider_dot_VueSliderDot = __decorate([vue_class_component_common_default.a], vue_slider_dot_VueSliderDot);
...
function (_Vue) {
  ...
  function VueSlideMark() {
    ...
    return _possibleConstructorReturn(this, getPrototypeOf_getPrototypeOf(VueSlideMark).apply(this, arguments));
  }
...
vue_slider_mark_VueSlideMark = __decorate([vue_class_component_common_default.a], vue_slider_mark_VueSlideMark);
...
function () {
  ...
  _createClass(Control, [{
    ...
    value: function setValue(value) {
      this.dotsValue = is_array_default()(value) ? _toConsumableArray(value) : [value];
      this.syncDotsPos();
    ...
    value: function getIndexByValue(value) {
      ...
      return new decimal_Decimal(+value).minus(this.min).divide(this.interval).toNumber();
    }
    /**
     * Get value by index
     *
    ...
    value: function getValueByIndex(index) {
      ...
      return this.data ? this.data[index] : new decimal_Decimal(index).multiply(this.interval).plus(this.min).toNumber();
    }
    /**
    ...
    value: function parseValue(val) {
      if (this.data) {
        ...
        val = new decimal_Decimal(val).minus(this.min).divide(this.interval).toNumber();
      }
    ...
    value: function getValues() {
      ...
      if (this.data) {
        ...
        return from_default()(new Array(this.total), function (_, index) {
          return new decimal_Decimal(index).multiply(_this5.interval).plus(_this5.min).toNumber();
        }).concat([this.max]);
      }
    }
  }, {
    ...
    get: function get() {
      ...
      var getMarkByValue = function getMarkByValue(value, mark) {
        ...
        return _objectSpread({
          pos: pos,
          value: typeof value === 'string' ? parse_float_default()(value) : value,
          label: value,
      ...
      if (this.marks === true) {
        ...
        return keys_default()(this.marks).sort(function (a, b) {
          return +a - +b;
        }).map(function (value) {
      ...
      } else if (is_array_default()(this.marks)) {
    ...
    get: function get() {
      ...
      if (this.data) {
        ...
        total = new decimal_Decimal(this.max).minus(this.min).divide(this.interval).toNumber();
      }
    ...
    get: function get() {
      ...
      dotsPos.forEach(function (pos, i) {
        valuePosRange.push([Math.max(_this7.minRange ? _this7.minRangeDir * i : 0, !_this7.enableCross ? dotsPos[i - 1] || 0 : 0), Math.min(_this7.minRange ? 100 - _this7.minRangeDir * (dotsPos.length - 1 - i) : 100, !_this7.enableCross ? dotsPos[i + 1] || 100 : 100)]);
      });
...
function (_Vue) {
  ...
  function VueSlider() {
    ...
    _this = _possibleConstructorReturn(this, getPrototypeOf_getPrototypeOf(VueSlider).apply(this, arguments));
  ...
  _createClass(VueSlider, [{
    ...
    value: function setScale() {
      this.scale = new decimal_Decimal(Math.floor(this.isHorizontal ? this.$el.offsetWidth : this.$el.offsetHeight)).divide(100).toNumber();
    }
  }, {
    key: "initControl",
    value: function initControl() {
      ...
      ['data', 'enableCross', 'fixed', 'max', 'min', 'interval', 'minRange', 'maxRange', 'order', 'marks', 'process'].forEach(function (name) {
        _this2.$watch(name, function (val) {
          if (name === 'data' && is_array_default()(_this2.control.data) && is_array_default()(val) && _this2.control.data.length === val.length && val.every(function (item, index) {
    ...
    value: function syncValueByPos() {
      ...
      if (this.isDiff(values, is_array_default()(this.value) ? this.value : [this.value])) {
        this.$emit('change', values.length === 1 ? values[0] : _toConsumableArray(values));
      }
    ...
    value: function dragMove(e) {
      ...
      this.$emit('dragging', value.length === 1 ? value[0] : _toConsumableArray(value));
    ...
    value: function render() {
      ...
      return h("div", {
        ...
        return _this6.renderSlot('mark', mark, h("vue-slider-mark", {
          ...
          "style": (_style = {}, _defineProperty(_style, _this6.isHorizontal ? 'height' : 'width', '100%'), _defineProperty(_style, _this6.isHorizontal ? 'width' : 'height', "".concat(_this6.tailSize, "px")), _defineProperty(_style, _this6.mainDirection, "".concat(mark.pos, "%")), _style),
          "on": {
        ...
        return h("vue-slider-dot", {
          ...
          "style": [_this6.dotBaseStyle, (_ref = {}, _defineProperty(_ref, _this6.mainDirection, "".concat(dot.pos, "%")), _defineProperty(_ref, "transition", "".concat(_this6.mainDirection, " ").concat(_this6.animateTime, "s")), _ref)],
          "on": {
      ...
      })]), this.dots.length === 1 && !this.data ? h("input", {
    ...
    key: "containerStyles",
    get: function get() {
      var _ref2 = is_array_default()(this.dotSize) ? this.dotSize : [this.dotSize, this.dotSize],
          _ref3 = _slicedToArray(_ref2, 2),
          dotWidth = _ref3[0],
          dotHeight = _ref3[1];

      var containerWidth = this.width ? toPx(this.width) : this.isHorizontal ? 'auto' : toPx(DEFAULT_SLIDER_SIZE);
      var containerHeight = this.height ? toPx(this.height) : this.isHorizontal ? toPx(DEFAULT_SLIDER_SIZE) : 'auto';
      return {
    ...
    get: function get() {
      ...
      return this.control.processArray.map(function (_ref4) {
        ...
        return _objectSpread((_objectSpread2 = {}, _defineProperty(_objectSpread2, _this7.isHorizontal ? 'height' : 'width', '100%'), _defineProperty(_objectSpread2, _this7.isHorizontal ? 'top' : 'left', 0), _defineProperty(_objectSpread2, _this7.mainDirection, "".concat(start, "%")), _defineProperty(_objectSpread2, sizeStyleKey, "".concat(end - start, "%")), _defineProperty(_objectSpread2, "transitionProperty", "".concat(sizeStyleKey, ",").concat(_this7.mainDirection)), _defineProperty(_objectSpread2, "transitionDuration", "".concat(_this7.animateTime, "s")), _objectSpread2), style);
      });
    }
  }, {
    key: "dotBaseStyle",
    get: function get() {
      var _ref7 = is_array_default()(this.dotSize) ? this.dotSize : [this.dotSize, this.dotSize],
      ...
      if (this.isHorizontal) {
        ...
        }, _defineProperty(_dotPos, this.direction === 'ltr' ? 'marginLeft' : 'marginRight', "-".concat(dotWidth / 2, "px")), _defineProperty(_dotPos, "top", '0'), _defineProperty(_dotPos, this.direction === 'ltr' ? 'left' : 'right', '0'), _dotPos);
      } else {
        var _dotPos2;

        dotPos = (_dotPos2 = {
          marginLeft: "-".concat((dotWidth - this.tailSize) / 2, "px")
        }, _defineProperty(_dotPos2, this.direction === 'btt' ? 'marginBottom' : 'marginTop', "-".concat(dotHeight / 2, "px")), _defineProperty(_dotPos2, "left", '0'), _defineProperty(_dotPos2, this.direction === 'btt' ? 'bottom' : 'top', '0'), _dotPos2);
      }
    ...
    get: function get() {
      ...
      if (is_array_default()(dir)) {
        return dir;
      } else {
        return from_default()(new Array(this.dots.length), function () {
          return dir;
        });
      }
    }
    ...
    get: function get() {
      ...
      return this.control.dotsPos.map(function (pos, index) {
        ...
        }, (is_array_default()(_this8.dotOptions) ? _this8.dotOptions[index] : _this8.dotOptions) || {});
      });
    }
  }, {
    key: "animateTime",
    ...
    get: function get() {
      var values = this.control.dotsValue;
      return is_array_default()(this.value) ? this.value.length !== values.length || this.value.some(function (val, index) {
